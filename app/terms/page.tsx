        ...
        <main className="flex-1">
          <div className="max-w-3xl mx-auto px-4 py-16">
            ...
            <div className="mt-8 space-y-8 text-muted-foreground [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mb-3 [&_h2]:text-foreground [&_p]:mb-3 [&_ul]:list-disc [&_ul]:list-inside [&_ul]:space-y-2">
              <p>
                These Terms of Service (&quot;Terms&quot;) govern access to and use of hate-it-or-love-it (the
              ...
              <section>
                ...
                <p>
                  hate-it-or-love-it is a public feed of fan opinion about movies. Posting a comment as
                  &quot;Love it&quot; (in favour) or &quot;Hate it&quot; (critical) costs a fixed ₹20, and you
