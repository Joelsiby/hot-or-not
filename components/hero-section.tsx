...
export const HeroSection = forwardRef<HTMLInputElement, HeroSectionProps>(
  function HeroSection({ selectedRank, selectedBid, onBidChange }, ref) {
      ...
      <section className="text-center overflow-hidden">
        ...
        <div className="mt-8 max-w-lg mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Button size="lg" className="h-12 px-8 rounded-full shrink-0">
              Claim
            </Button>
          </div>
          <p className="text-xs text-muted-foreground mt-2">
            Already on the list? Enter the same URL or @handle and up your bid — you only pay the difference.
          </p>
        </div>
      </section>
    )
